...
Route::post('animals_mass_destroy', ['uses' => 'AnimalsController@massDestroy', 'as' => 'animals.mass_destroy']);
Route::resource('checkups', 'CheckupsController');
Route::post('checkups_mass_destroy', ['uses' => 'CheckupsController@massDestroy', 'as' => 'checkups.mass_destroy']);
  Route::get('vet', function () {
    return view('pages.vet');
  });

  Route::get('Vetarea', function () {
    return view('pages.Vetarea');
  });
